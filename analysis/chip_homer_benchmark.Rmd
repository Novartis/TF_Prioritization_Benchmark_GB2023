---
title: "ChIP-seq Homer benchmark"
...
# Define output path
out.path <- '/da/dmp/cb/steinse5/projects/tf_tool_benchmark/output/benchmark_data/chipseq/homer2/'
...
homer.txts <- homer.txts[-grep(homer.txts, pattern = 'benchmark_(rmd|neutral)_bg')]
