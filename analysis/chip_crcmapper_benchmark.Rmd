---
title: "ChIP-seq CRCmapper benchmark"
...
# Define output path
out.path <- '/da/dmp/cb/steinse5/projects/tf_tool_benchmark/output/benchmark_data/chipseq/crcmapper/'
...
if(!file.exists(file.path(out.path, "CRCmapper_benchmark.RDS"))) {
  # Save results as *.rds
  saveRDS(crc.list[["betweenness"]], file=file.path(out.path, "CRCmapper_benchmark.RDS"))
  saveRDS(top.ten[["betweenness"]], file=file.path(out.path, "CRCmapper_topTen.RDS"))
  saveRDS(roc.pr.str[["betweenness"]], file=file.path(out.path, "CRCmapper_roc_pr_str.RDS"))
  saveRDS(roc.pr.unstr[["betweenness"]], file=file.path(out.path, "CRCmapper_roc_pr_unstr.RDS"))
  saveRDS(info.df[["betweenness"]], file=file.path(out.path, "CRCmapper_info.RDS"))
}
