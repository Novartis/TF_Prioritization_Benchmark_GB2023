---
title: "ATAC-seq - GimmeMotifs benchmark"
...
# Define output path
out.path <- '/da/dmp/cb/steinse5/projects/tf_tool_benchmark/output/benchmark_data/atacseq/gimmemotifs/'

# Read in all knownResults.txt output files from gimme for every dataset
gimme.txts <- list.files("/da/dmp/cb/steinse5/projects/tf_tool_benchmark/data/atacseq/",
