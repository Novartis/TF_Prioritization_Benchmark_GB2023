...
# Define output path
out.path <- '/da/dmp/cb/steinse5/projects/tf_tool_benchmark/output/benchmark_data/atacseq/lola/'

# Read in all knownResults.txt output files from lola for every dataset
lola.txts <- list.files("/da/dmp/cb/steinse5/projects/tf_tool_benchmark/data/atacseq/",
...
if(!file.exists(file.path(out.path, "lola_benchmark.RDS"))) {
  ...
  lola.list <- list('using background peaks' = lola.results)
