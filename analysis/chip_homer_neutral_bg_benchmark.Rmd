---
title: "ChIP-seq Homer benchmark (neutral bg)"
...
# Define output path
out.path <- '/da/dmp/cb/steinse5/projects/tf_tool_benchmark/output/benchmark_data/chipseq_neutral_bg/homer/'
...
homer.txts <- homer.txts[grep(homer.txts, pattern = 'benchmark_neutral_bg')]
...
if(!file.exists(file.path(out.path, "homer_neutral_bg_benchmark.RDS"))) {
  ...
  homer.list <- file.path(out.path, "homer_neutral_bg_benchmark.RDS")
  top.ten <- file.path(out.path, "homer_neutral_bg_topTen.RDS")
  roc.pr.str <- file.path(out.path, "homer_neutral_bg_roc_pr_str.RDS")
  roc.pr.unstr <- file.path(out.path, "homer_neutral_bg_roc_pr_unstr.RDS")
  info.df <- file.path(out.path, "homer_neutral_bg_info.RDS")
  topMotifs.df <- file.path(out.path, "homer_neutral_bg_topMotifs_lambert.RDS")
}
...
if(!file.exists(file.path(out.path, "homer_neutral_bg_benchmark.RDS"))) {
  # Save results as *.rds
  saveRDS(homer.list, file=file.path(out.path, "homer_neutral_bg_benchmark.RDS"))
  saveRDS(top.ten, file=file.path(out.path, "homer_neutral_bg_topTen.RDS"))
  saveRDS(roc.pr.str, file=file.path(out.path, "homer_neutral_bg_roc_pr_str.RDS"))
  saveRDS(roc.pr.unstr, file=file.path(out.path, "homer_neutral_bg_roc_pr_unstr.RDS"))
  saveRDS(info.df, file=file.path(out.path, "homer_neutral_bg_info.RDS"))
  saveRDS(topMotifs.df, file=file.path(out.path, "homer_neutral_bg_topMotifs_lambert.RDS"))
}
```
