---
title: "ATAC-seq - RcisTarget benchmark"
...
# Define output path
out.path <- '/da/dmp/cb/steinse5/projects/tf_tool_benchmark/output/benchmark_data/atacseq/rcistarget/'

# Read in all rcistarget output files for every experiment
rcistarget.txts <- list.files("/da/dmp/cb/steinse5/projects/tf_tool_benchmark/data/atacseq/",
